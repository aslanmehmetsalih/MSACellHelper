...
//  MSACellHelper
//
//  Created by Mehmet Salih Aslan on 7.12.2018.
//
...
public extension UICollectionView {
    ...
    func registerHeader<T: UICollectionReusableView>(_: T.Type) where T: ReusableView, T: NibLoadableView {
        ...
        register(nib, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: T.defaultReuseIdentifier)
    }
    ...
    func registerFooter<T: UICollectionReusableView>(_: T.Type) where T: ReusableView, T: NibLoadableView {
        ...
        register(nib, forSupplementaryViewOfKind: UICollectionElementKindSectionFooter, withReuseIdentifier: T.defaultReuseIdentifier)
    }
}
